...
4. A trimmed Codex experiment thread starting with `it's time to perform experiments...`.
...
- `sessions/design_variant_experiments_trimmed.md`: Readable transcript of the experiment thread.
