...
#define CFG_ITERATIVE_DEEPENING 0
...
#define CFG_OPENING_BOOK 1
#define CFG_PAWN_HASH_TABLE 0
#define CFG_PAWN_STRUCTURE 1
#define CFG_PIECE_LISTS 0
#define CFG_PIECE_SQUARE_TABLES 0
...
#define PL_SELECTED_OPTION_COUNT 19
